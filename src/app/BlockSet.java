...
public class BlockSet {
    ...
    public void inicializarArquivosBlocos() {
        try{
            for(int i =0; i <qtdArquivos; ++i){                                           //inicializar os arquivos temporários
                arquivosEscrita[i] = new RandomAccessFile(new File("arquivo_0"+i+".tmp"), "rw");
    ...
    public void abrirArquivos() {
        try{
            for(int i =0; i <qtdArquivos; ++i){                                           //inicializar os arquivos temporários
                ...
                arquivosLeitura[i] = new RandomAccessFile(new File("arquivo_0"+(i+qtdArquivos)+".tmp"), "rw");
                ...
                //exemplo: i=0, qtdArquivos =3, arquivo de saida = arquivo_03 (i+QTDArquivos = 3)
    ...
    public void abrirArquivoEscrita(int arq) {
        try{
            if(fontesAlternadas){
                arquivosLeitura[arq] = new RandomAccessFile("arquivo_0"+(arq+qtdArquivos)+".tmp", "rw");

            }
            else{
                arquivosEscrita[arq] = new RandomAccessFile("arquivo_0"+arq+".tmp", "rw");
            }
